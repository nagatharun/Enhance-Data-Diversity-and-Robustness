...
def initialize_paths():
    base_input = "/student/vcheruku/datasets/CholecSeg8k"# raw directory structure location downladed from kaggle 
    base_output = "/student/vcheruku/Enhance-Data-Diversity-and-Robustness/yolo-for-single-class" #processed data structure location
